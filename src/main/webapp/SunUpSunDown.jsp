...
<head>
    ...
    <link rel="stylesheet" href="static/my/css/SunUpSunDown.css"  media="all">
</head>
<body style="width: 100%; height: 100%; margin: 0; padding: 0" onmouseup="stopMove();" onresize="windowResize();">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input type="text" style="z-index: 10002;position: absolute;width: 20%; margin-top: 28%; margin-left: 33%;" name="title" lay-verify="title" autocomplete="off" placeholder="请输入物流单号" class="layui-input">
            <button style="z-index: 10002;position: absolute;width: 5%;margin-top: 28%; margin-left: 54%;" class="layui-btn layui-btn-fluid">物流查询</button>
        </div>
    </div>
    <script src="static/layui/layui.js" charset="utf-8"></script>
    <script src="static/my/js/SunUpSunDown.js"></script>
</body>
</html>