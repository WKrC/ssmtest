...
<div class="layui-input-block" style="top: -5%;">
    ...
    <input type="text" id="sender_addr" style="z-index: 3;position: absolute;width: 20%; margin-top: 30%; margin-left: 37%;" readonly name="title" lay-verify="title" autocomplete="off" placeholder="请输入寄件人地址" class="layui-input">
    ...
    <input type="text" id="consignee_addr" style="z-index: 3;position: absolute;width: 20%; margin-top: 39%; margin-left: 37%;" readonly name="title" lay-verify="title" autocomplete="off" placeholder="请收件人地址" class="layui-input">
    <input type="text" id="remaker" style="z-index: 3;position: absolute;width: 20%; margin-top: 42%; margin-left: 37%;" readonly name="title" lay-verify="title" autocomplete="off" placeholder="请输入备注" class="layui-input">
